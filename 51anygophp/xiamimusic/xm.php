...
//href="http://www.xiami.com/song/1770982636" title="iLove"
...
#href="javascript:void(0)" title="下载" onclick="xm_download('1369402');"><span>下载</span></a>
//preg_match_all('/href=\"\/song\/([0-9]+)\" title=/',$x_con, $locations);
// onclick="xm_download('1369402');">
preg_match_all('/xm_download\(\'([0-9]+)\'\)\;/',$x_con, $locations);
